...
export class PaymentService {
  ...
  private readonly PRICING: PricingConfig = {
    ...
    IOS_MARKUP: 1.3, // +30% for Apple commission
  };
  ...
  private readonly CREDIT_PACKS: CreditPack[] = [
    ...
    },
    {
      id: "pack_20",
      credits: 20,
      price: this.PRICING.PACK_20,
      currency: "EUR",
      name: "20 Credits Pack",
    },
  ];

  private readonly SUBSCRIPTION_PLANS: Record<
    SubscriptionPlan,
    { price: number; credits: number; accounts: number; duration?: number }
  > = {
    ...
    [SubscriptionPlan.ANNUAL]: {
      price: this.PRICING.ANNUAL,
      credits: 120,
      accounts: 5,
    },
    [SubscriptionPlan.ENTERPRISE]: {
      price: this.PRICING.ENTERPRISE,
      credits: 30,
      accounts: 10,
    },
    [SubscriptionPlan.PASS_48H]: {
      price: this.PRICING.PASS_48H,
      credits: 0,
      accounts: 1,
      duration: 48,
    }, // 48 hours in hours
  ...
  async updateSubscription(
    ...
    try {
      ...
      // Send update email
      await this.emailService.sendSubscriptionUpdated(
        subscription.userId,
        updatedSubscription,
      );
  ...
  async addCredits(
    ...
    console.log(
      `[Credits] Added ${amount} credits to user ${userId}: ${reason}`,
    );
  }
