...
// Social accounts
router.get('/:id/social-accounts', brandsController.getSocialAccounts.bind(brandsController));
router.post('/:id/social-accounts', brandsController.connectSocialAccount.bind(brandsController));
...
// Analytics
router.get('/:id/analytics', brandsController.getAnalytics.bind(brandsController));
