              ...
              >
                <div className="bg-bg-elevated rounded-2xl shadow-2xl shadow-red-500/10 p-8 border border-white/10">
                  <div className="text-center mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-white">YouTube Comment Picker</h2>
          ...
          <div className="grid lg:grid-cols-[280px_1fr] gap-12">
            ...
            <main className="min-w-0">
                  ...
                  {[
                    ...
                    <div key={item.step} className="bg-bg-elevated rounded-xl p-6 border border-white/10 shadow-sm">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <div className="text-sm font-medium text-red-400 mb-1">Step {item.step}</div>
              ...
              <section id="features" className="mb-16">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    ...
                    <div key={index} className={`bg-bg-elevated rounded-xl p-6 border ${feature.highlight ? 'border-red-200 ring-2 ring-red-100' : 'border-white/10'}`}>
                      <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 ${feature.highlight ? 'bg-red-600 text-white' : 'bg-gray-100 text-ink-secondary'}`}>
                        {feature.icon}
                      </div>
              ...
              <section id="giveaway-types" className="mb-16">
                <h2 className="text-3xl font-bold text-white mb-8">YouTube Giveaway Types</h2>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <Link key={index} to={type.link} className="block bg-bg-elevated rounded-xl p-6 border border-white/10 hover:border-red-200 hover:shadow-lg transition-all group">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-red-500/20 rounded-xl flex items-center justify-center text-red-400 group-hover:bg-red-600 group-hover:text-white transition-all">
                          {type.icon}
                        </div>
                        <div className="flex-1">
                          <h3 className="text-lg font-semibold text-white group-hover:text-red-400">{type.title}</h3>
                          <p className="text-ink-secondary text-sm">{type.description}</p>
                        </div>
                        <ArrowRight className="w-5 h-5 text-ink-tertiary group-hover:text-red-500" />
                      </div>
                    </Link>
                  ))}
                </div>
              ...
              <section id="tips" className="mb-16">
                <h2 className="text-3xl font-bold text-white mb-8">YouTube Giveaway Tips</h2>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={index} className="bg-bg-elevated rounded-xl p-6 border border-red-100">
              ...
              <section className="bg-red-600 rounded-2xl p-8 md:p-12 text-center text-white">
                ...
                <Link to="/draw/new" className="inline-flex items-center gap-2 bg-bg-elevated text-red-400 px-8 py-4 rounded-xl font-semibold text-lg hover:shadow-lg transition-all">
                  <Sparkles className="w-5 h-5" />
                  Pick Winner Free
                </Link>
              </section>
