            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="text-center mb-6">
                  ...
                  <h2 className="text-xl font-bold text-gray-900">Tirage Retweets</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <motion.div
                  ...
                  className="bg-sky-50 rounded-xl p-6 hover:bg-sky-100 transition-all"
                >
                  <div className="w-12 h-12 bg-white text-sky-600 rounded-xl flex items-center justify-center mb-4 shadow-sm">
                    {benefit.icon}
                  </div>
                ...
                <div key={index} className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sky-600 text-sm italic">{format.example}</p>
                    </div>
                  </div>
                </div>
              ))}
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {howToSteps.map((step, index) => (
                <div key={index} className="relative">
                  <div className="bg-gradient-to-br from-sky-50 to-blue-50 rounded-xl p-6 border border-sky-100 h-full">
