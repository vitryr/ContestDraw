  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-sky-50 via-white to-gray-50">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                  <Link
                    to="/draw/new"
                    className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-pink-500 to-red-500 text-white px-8 py-4 rounded-xl font-semibold hover:shadow-lg transition-all"
                  >
              ...
              >
                <div className="text-center mb-6">
                  ...
                  <h2 className="text-xl font-bold text-gray-900">Tirage Likes Twitter</h2>
                  <p className="text-gray-500 text-sm mt-2">Collez le lien de votre tweet</p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <Link
                    to="/draw/new"
                    className="w-full inline-flex items-center justify-center gap-2 bg-gradient-to-r from-pink-500 to-red-500 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all"
                  >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-pink-50 to-red-50 rounded-xl p-6 border border-pink-100">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900">Tirage Likes ❤️</h3>
                </div>
              ...
              <div className="bg-gradient-to-br from-sky-50 to-blue-50 rounded-xl p-6 border border-sky-100">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900">Tirage Retweets 🔄</h3>
                </div>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {howToSteps.map((step, index) => (
                <div key={index} className="relative">
                  <div className="bg-gradient-to-br from-pink-50 to-red-50 rounded-xl p-6 border border-pink-100 h-full">
                    <div className="w-10 h-10 bg-gradient-to-r from-pink-500 to-red-500 rounded-full flex items-center justify-center text-white font-bold mb-4">
                      {index + 1}
                    </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={index} className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
                  ...
                  <p className="text-gray-600 text-sm italic">{example.note}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Autres Types de Tirages Twitter/X</h2>
