          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="mt-12 flex items-center gap-8">
                <div>
                  <div className="text-3xl font-bold text-gray-900">{t('landing.hero.stat1')}</div>
                  <div className="text-sm text-gray-600">{t('landing.hero.stat1Label')}</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-gray-900">{t('landing.hero.stat2')}</div>
                  <div className="text-sm text-gray-600">{t('landing.hero.stat2Label')}</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-gray-900">{t('landing.hero.stat3')}</div>
                  <div className="text-sm text-gray-600">{t('landing.hero.stat3Label')}</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="aspect-[9/16] max-w-sm mx-auto bg-gradient-to-br from-primary-500 to-accent-500 rounded-3xl shadow-2xl p-8 flex items-center justify-center">
                <div className="text-center text-white">
                  ...
                  <div className="text-2xl font-bold mb-2">Winner Announcement</div>
                  <div className="text-primary-100">Professional animated video</div>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container-custom">
          <div className="bg-gradient-to-br from-primary-600 to-accent-600 rounded-3xl p-12 text-center text-white">
            ...
            <Link to="/auth" className="inline-block bg-white text-primary-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
