  ...
  return (
    <div className={`min-h-screen ${bgColor} p-4`}>
      <div className="max-w-2xl mx-auto">
        {/* Header */}
        <div
          className={`${bgSecondary} rounded-lg p-4 mb-4 border ${borderColor}`}
        >
        ...
        <div className={`rounded-lg p-4 mb-4 border ${borderColor} ${bgColor}`}>
          <h4
            className={`font-semibold ${textColor} mb-3 flex items-center gap-2`}
          >
            <Trophy
        ...
        {showParticipants && data.participants && (
          <div
            className={`rounded-lg p-4 mb-4 border ${borderColor} ${bgColor}`}
          >
            <h4
              className={`font-semibold ${textColor} mb-3 flex items-center gap-2`}
            >
            ...
            <div className="grid grid-cols-2 gap-2 max-h-64 overflow-y-auto">
              {data.participants.slice(0, 20).map((participant, index) => (
                <div
                  key={index}
                  className={`text-sm ${textSecondary} truncate`}
                >
